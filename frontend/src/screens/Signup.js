...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (json.success) {
      ...
      localStorage.setItem('address', credentials.geolocation);
  ...
  return (
    <div style={{ 
      ...
      <div className='container h-100 d-flex justify-content-center align-items-center'>
        <form className='w-50 border bg-dark border-success rounded p-4' onSubmit={handleSubmit}>
          <div className="m-3">
          ...
          <div className="m-3">
            ...
            <input type="text" className="form-control" name='phone' value={credentials.phone} onChange={onChange} aria-describedby="phoneHelp" />
          </div>
          <div className="m-3">
